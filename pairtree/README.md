...
8. Runs a smoke test: `pairtree --help`, plus a real end-to-end run on Pairtree's bundled example data, to confirm the install actually works (not just that the CLI starts)
