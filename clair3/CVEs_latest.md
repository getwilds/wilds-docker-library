# Vulnerability Report for getwilds/clair3:latest

Report generated on 2026-04-03 03:15:36 PST
...
```bash
docker scout quickview getwilds/clair3:latest --platform linux/amd64
```
